<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="editArtistProfile.aspx.cs" Inherits="test2.LHY.ASPX.editArtistProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="form">
            ...
            <tr><td colspan="2">
                <asp:TextBox ID="txtUsername" runat="server" class="textfield" placeholder="First name and Last name" ></asp:TextBox>
            ...
            <tr><td colspan="2" >
                &nbsp;<tr><td colspan="2">
                    <asp:Button ID="btnUpdate" runat="server" Text="Update Profile" CssClass="buttonUpdate" OnClick="BtnUpdate_Click"/>
                </td></tr>
        </table>
