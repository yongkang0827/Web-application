...
{
    public partial class editArtistProfile : System.Web.UI.Page
    {
        ...
        protected void BtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string strSelect = "Select * From Artist where Username=@name";
                ...
                if (dtrProd.HasRows)
                {
                    while (dtrProd.Read())
                    {
                        userId = dtrProd["ArtistID"].ToString();
                ...
                con.Open();
                string strAdd = "Update Artist Set Username = @newname, Phone = @phone, Email = @email, Password = @passw Where ArtistID=@oldid";
